...
class NeoDeployTest extends BasePiperTest {
    ...
    void scriptNotProvidedTest() {
        ...
        jsr.step.call(script: nullScript, cpe: nullScript.commonPipelineEnvironment, archivePath: archiveName)
    }

    @Test
    void mtaDeployModeTest() {

        jsr.step.call(script: nullScript, cpe: nullScript.commonPipelineEnvironment, archivePath: archiveName, deployMode: 'mta')
