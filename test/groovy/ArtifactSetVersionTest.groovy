...
class ArtifactSetVersionTest extends BasePiperTest {
    ...
    @Test
    void testVersioning() {
        jsr.step.artifactSetVersion(cpe: nullScript.commonPipelineEnvironment, script: jsr.step, juStabGitUtils: gitUtils, buildTool: 'maven', gitSshUrl: 'myGitSshUrl')
    ...
    void testVersioningWithoutCommit() {
        jsr.step.artifactSetVersion(cpe: nullScript.commonPipelineEnvironment, script: jsr.step, juStabGitUtils: gitUtils, buildTool: 'maven', commitVersion: false)
    ...
    void testVersioningWithoutScript() {
        jsr.step.artifactSetVersion(cpe: nullScript.commonPipelineEnvironment, juStabGitUtils: gitUtils, buildTool: 'maven', commitVersion: false)
    ...
    void testVersioningCustomGitUserAndEMail() {
        jsr.step.artifactSetVersion(cpe: nullScript.commonPipelineEnvironment, script: jsr.step, juStabGitUtils: gitUtils, buildTool: 'maven', gitSshUrl: 'myGitSshUrl', gitUserEMail: 'test@test.com', gitUserName: 'test')
    ...
    void testVersioningWithTimestamp() {
        jsr.step.artifactSetVersion(cpe: nullScript.commonPipelineEnvironment, script: jsr.step, juStabGitUtils: gitUtils, buildTool: 'maven', timestamp: '2018')
    ...
    void testVersioningNoBuildTool() {
        ...
        jsr.step.artifactSetVersion(cpe: nullScript.commonPipelineEnvironment, script: jsr.step, juStabGitUtils: gitUtils)
    }

    @Test
    void testVersioningWithCustomTemplate() {
        jsr.step.artifactSetVersion(cpe: nullScript.commonPipelineEnvironment, script: jsr.step, juStabGitUtils: gitUtils, buildTool: 'maven', versioningTemplate: '${version}-xyz')
    ...
    void testVersioningWithTypeAppContainer() {
        ...
        jsr.step.artifactSetVersion(cpe: nullScript.commonPipelineEnvironment, script: jsr.step, juStabGitUtils: gitUtils, buildTool: 'docker', artifactType: 'appContainer', dockerVersionSource: 'appVersion')
        assertEquals('1.2.3-xyz', jer.env.getArtifactVersion())
