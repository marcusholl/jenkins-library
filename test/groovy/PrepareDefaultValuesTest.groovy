...
public class PrepareDefaultValuesTest extends BasePiperTest {
    ...
    public void testReInitializeOnCustomConfig() {
        ...
        jsr.step.call(script: nullScript, cpe: nullScript.commonPipelineEnvironment, customDefaults: 'custom.yml')
    ...
    public void testAttemptToLoadNonExistingConfigFile() {
        ...
        jsr.step.call(script: nullScript, cpe: nullScript.commonPipelineEnvironment, customDefaults: 'not_found')
    }
