...
type transportRequestUploadCTSXXXOptions struct {
...
// TransportRequestUploadCTSXXXCommand Uploads content to a transport request
func TransportRequestUploadCTSXXXCommand() *cobra.Command {
	const STEP_NAME = "transportRequestUploadCTSXXX"

	metadata := transportRequestUploadCTSXXXMetadata()
	var stepConfig transportRequestUploadCTSXXXOptions
	var startTime time.Time

	var createTransportRequestUploadCTSXXXCmd = &cobra.Command{
		Use:   STEP_NAME,
		...
		Run: func(_ *cobra.Command, _ []string) {
			...
			transportRequestUploadCTSXXX(stepConfig, &telemetryData)
			telemetryData.ErrorCode = "0"
			log.Entry().Info("SUCCESS")
		},
	}

	addTransportRequestUploadCTSXXXFlags(createTransportRequestUploadCTSXXXCmd, &stepConfig)
	return createTransportRequestUploadCTSXXXCmd
}

func addTransportRequestUploadCTSXXXFlags(cmd *cobra.Command, stepConfig *transportRequestUploadCTSXXXOptions) {
...
func transportRequestUploadCTSXXXMetadata() config.StepData {
	var theMetaData = config.StepData{
		Metadata: config.StepMetadata{
			Name:        "transportRequestUploadCTSXXX",
