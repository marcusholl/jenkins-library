...
type cloudFoundryDeployOptions struct {
	...
	MtaExtensionCredentials  string   `json:"mtaExtensionCredentials,omitempty"`
...
func addCloudFoundryDeployFlags(cmd *cobra.Command, stepConfig *cloudFoundryDeployOptions) {
	...
	cmd.Flags().StringVar(&stepConfig.MtaExtensionCredentials, "mtaExtensionCredentials", os.Getenv("PIPER_mtaExtensionCredentials"), "Defines a map of credentials that need to be replaced in the `mtaExtensionDescriptor`. This map needs to be created as `value-to-be-replaced`:`id-of-a-credential-in-jenkins`")
