...
type transportRequestUploadOptions struct {
...
// TransportRequestUploadCommand Uploads content to a transport request
func TransportRequestUploadCommand() *cobra.Command {
	const STEP_NAME = "transportRequestUpload"

	metadata := transportRequestUploadMetadata()
	var stepConfig transportRequestUploadOptions
	var startTime time.Time

	var createTransportRequestUploadCmd = &cobra.Command{
		Use:   STEP_NAME,
		...
		Run: func(_ *cobra.Command, _ []string) {
			...
			transportRequestUpload(stepConfig, &telemetryData)
			telemetryData.ErrorCode = "0"
			log.Entry().Info("SUCCESS")
		},
	}

	addTransportRequestUploadFlags(createTransportRequestUploadCmd, &stepConfig)
	return createTransportRequestUploadCmd
}

func addTransportRequestUploadFlags(cmd *cobra.Command, stepConfig *transportRequestUploadOptions) {
...
func transportRequestUploadMetadata() config.StepData {
	var theMetaData = config.StepData{
		Metadata: config.StepMetadata{
			Name:    "transportRequestUpload",
